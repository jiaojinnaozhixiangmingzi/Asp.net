<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEdit.aspx.cs" Inherits="VIEW.UserEdit" %>
...
<div  class="navbar navbar-default navbar-fixed-top" >
	<div  class="container">
		<div  class="navbar-header">
			...
			<a  class="navbar-brand hidden-sm"  href="http://www.oxcoder.com/index.htm"  style="padding: 0;"><img  src="./picture/wlogo_sm.png"  style="max-height: 35px; margin: 7px;"></a>
		</div>
		<div  class="navbar-collapse collapse"  role="navigation">
			<ul  class="nav navbar-nav">
				<li><a  href="user_index.htm">首页</a></li>
				<li><a  href="user_chan.htm">挑战</a></li>
				...
				<ul  class="nav navbar-nav navbar-right">
					...
					<li  class="dropdown"><a  href="http://www.oxcoder.com/user-resume-operation.action?type=info#"  class="dropdown-toggle"  data-toggle="dropdown"><span  class="text"><%=person.mail%></span> <b  class="caret"></b></a>
	...
	<div  class="container">
		<div  class="row">
			...
			<div  class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
				<section  id="middle">
					<form  id="defaultForm"  runat="server" method="post"  class="form-vertical bv-form"   novalidate="novalidate"><button  type="submit"  class="bv-hidden-submit"  style="display: none; width: 0px; height: 0px;"></button>

						<div  class="form-group">
							<label><h3  class="grey">真实姓名</h3></label> 
                            <input  type="text"  id="edit_name"  name="edit_username"  value="<%=person.username%>" class="form-control"  placeholder=""  data-bv-field="name">
						...
						<div  class="form-group">
							<label><h3  class="grey">年龄</h3></label>
                             <input  type="text"  id="edit_age"  name="edit_age"  value="<%=person.age%>"  class="form-control"  data-bv-field="age"> <span  class="text-danger"  id="error1"  style="display: none;"></span> <span  class="help-block"  id="hint1">
						...
						<div  class="form-group">
							...
							<div>
                                ...
                                <asp:RadioButton ID="radio_boy"  Text="男" runat="server"  GroupName="Sex" />
                                <asp:RadioButton ID="radio_girl" Text="女" runat="server"  GroupName="Sex"/>
								<%--
                                    <label  class="radio-inline"  for="example-inline-radio1">
									<input checked=""  type="radio"  id="example-inline-radio1"  name="sex"  value="1"  data-bv-field="sex">
									男
								</label> 
                                <label  class="radio-inline"  for="example-inline-radio2">
									<input   type="radio"  id="example-inline-radio2"  name="sex"  value="0"  data-bv-field="sex">
									女
								</label>--%>
							</div>
						...
						<div  class="form-group">
							<label><h3  class="grey">手机</h3></label> 
                            <input  type="text"  id="edit_phone"  name="edit_phone"  value="<%=person.phone%>"  class="form-control"  data-bv-field="phone">
						...
						<div  class="form-group form-actions pull-right">
                            <asp:Button ID="Button1" runat="server" Text="保存" type="submit"  class="btn btn-new1 btn-lg"  OnClick="Save" style="border-radius: 3px;"/>
							<!--<button  type="submit"  class="btn btn-new1 btn-lg"  OnClick="btn" style="border-radius: 3px;">保存</button> -->
						</div>
