	...
	<div  class="container">
		<div  class="row">
			<div  class="col-md-12">
				...
				<small> <a  href="boss_index.htm"><i  class="imoon imoon-arrow-left2"></i> 返回 </a>
					</small>
			</div>
			...
			<div  class="col-md-12">
				...
				<div  class="col-md-12">
					<section  id="middle">
						<h2  class="h2-tab">
							<a  href="http://www.oxcoder.com/hr-recruit-resume-list.action?reid=1099&isdeal=all&&searchOrder=ranking">全部（<%=recievenumber%>）
							</a>
						</h2>
						<h2  class="h2-tab">
							<a  href="http://www.oxcoder.com/hr-recruit-resume-list.action?reid=1099&isdeal=unfinish&searchOrder=ranking"  class="off">未完成（1）
							</a>
						</h2>
						<h2  class="h2-tab">
							<a  href="http://www.oxcoder.com/hr-recruit-resume-list.action?reid=1099&isdeal=approve&searchOrder=ranking"  class="off">推荐（0）
							</a>
						</h2>
						<h2  class="h2-tab">
							<a  href="http://www.oxcoder.com/hr-recruit-resume-list.action?reid=1099&isdeal=pass&searchOrder=ranking"  class="off">合格（0）
							</a>
						</h2>
						<h2  class="h2-tab">
							<a  href="http://www.oxcoder.com/hr-recruit-resume-list.action?reid=1099&isdeal=fail&searchOrder=ranking"  class="off">不合格（0）
							</a>
						</h2>
					</section>
				</div>
