<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="VIEW.WebForm4" %>
...
<body>
				...
				<section  id="middle">
					...
					<div  id="content"  class="signin-page">
						...
						<div  class="panel-group"  id="signin-page">
							...
							<h3  class="panel-title"  style="color: #fff;font-size: 2.4em;padding: 25px 25px 10px;text-shadow: 0 1px 2px rgba(0, 0, 0, 0.1);"><img  src="./picture/wlogo.png">猿圈注册</h3>
							<div  class="panel panel-outline panel-no-padding"  style="border: none;">
								<div  id="signin"  class="panel-collapse collapse in">
									<div  class="panel-body col-md-6">
										<form  action="boss_index.htm"  method="post"  id="defaultForm"  class="form-horizontal bv-form"  novalidate="novalidate"><button  type="submit"  class="bv-hidden-submit"  style="display: none; width: 0px; height: 0px;"></button>
    ...
    <div>
        ...
        <p>
             &nbsp;</p>
    <div>
        <asp:HyperLink ID="HyperLink2" runat="server">邮箱</asp:HyperLink>
    </div>
