<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserChallenge.aspx.cs" Inherits="VIEW.UserChallenge" %>
	...
	<div  class="container">
		...
		<div  class="navbar-collapse collapse"  role="navigation">
			<ul  class="nav navbar-nav">
				...
				<li class="active"><a  href="UserChallenge.aspx">挑战</a></li>
				...
				<ul  class="nav navbar-nav navbar-right">
					...
					<li  class="dropdown"><a  href="http://www.oxcoder.com/user-recruit-list.htm#"  class="dropdown-toggle"  data-toggle="dropdown"><span  class="text">王海鑫</span> <b  class="caret"></b></a>
		...
		<div  class="row">
			<div  class="col-md-12">
				<section  id="middle">
					...
					<h2  class="h2-tab">
						<a  href="UserCHallenge.aspx">我接受的挑战</a><!--根据标签选择-->
					</h2>
					<h2  class="h2-tab">
						<a  href="HistoryCHallenge.aspx"  onclick="history_click" class="off">挑战历史</a>
					</h2>
				</section>
			</div>
