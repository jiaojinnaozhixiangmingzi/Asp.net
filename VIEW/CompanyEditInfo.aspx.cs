...
namespace VIEW
{
    public partial class CompanyEditInfo : System.Web.UI.Page
    {
        ...
        {
            HttpCookie RefuseReturn = new HttpCookie("return");
         //   HttpCookie CookieUserPassword = new HttpCookie("Pass");
            RefuseReturn.Value = "123";
         //   CookieUserPassword.Value = UserPass;
            RefuseReturn.Expires = DateTime.Now.AddDays(30);
          //  CookieUserPassword.Expires = DateTime.Now.AddDays(30);

            Response.Cookies.Add(RefuseReturn);
         //   Response.Cookies.Add(CookieUserPassword);
            //Label1.Text=(string)Session["useremail"];
